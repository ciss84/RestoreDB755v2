...
function toggle_payload(pld){
	if(pld == "exploit"){
		...
		document.getElementById("progress").innerHTML="Loading Silver755x82-v2.0c.. Please wait..";
		...
		document.getElementById("progress").innerHTML="Loading SilverMiraSP7.. Please wait..";
		preloadScripts(['henSP7.js','jsloader.js']);
	}else if(pld == "henSP8"){
		document.getElementById("progress").innerHTML="Loading SilverMiraSP8.. Please wait..";
		...
		document.getElementById("progress").innerHTML="Loading Restore DB File.. Please wait..";
